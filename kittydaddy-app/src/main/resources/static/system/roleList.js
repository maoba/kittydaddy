...
//	$.get("/role/roleList?pageIndex=1&pageSize=10", function(data){
//		//正常加载信息
...
//		//分页
//		var nums = that.pageSize; //每页出现的数据量
//		if(that){
//			newsData = that;
//		}
////		alert(newsData.list)
////		alert(Math.ceil(newsData.length/nums));
//		laypage({
//			cont : "role_page",
//			pages : newsData.pages,
//			curr:newsData.pageNum, //当前页  
//			jump : function(obj){
//				debugger
