package com.kittydaddy.search.model.pvcontent;
 ...
 * 发布到搜索引擎
 */
@Document(indexName = "pvcontent", type = "pvcontent")
public class PublishContentEntity {
    ...
    private List<KVContentItemEntity> contentItems;

    private List<KVContentSourceEntity> contentSources;
    
	public List<KVContentSourceEntity> getContentSources() {
		return contentSources;
	}

	public void setContentSources(List<KVContentSourceEntity> contentSources) {
	...
	public List<KVContentItemEntity> getContentItems() {
		return contentItems;
	}


	public void setContentItems(List<KVContentItemEntity> contentItems) {
