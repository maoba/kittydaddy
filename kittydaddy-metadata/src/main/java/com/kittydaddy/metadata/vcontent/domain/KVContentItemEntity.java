package com.kittydaddy.metadata.vcontent.domain;
 ...
 * 
 */
public class KVContentItemEntity {
	/**
	 * 编码id
	 */
    private String id;
     ...
     */
    @Transient
    private List<KVContentSourceEntity> contentSourceList;
    
    public List<KVContentSourceEntity> getContentSourceList() {
		return contentSourceList;
	}

	public void setContentSourceList(List<KVContentSourceEntity> contentSourceList) {
