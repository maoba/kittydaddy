package com.kittydaddy.common.exception;
...
public class ParamCheckException extends RuntimeException{
     ...
     */
    public ParamCheckException(String errorCode, String message, boolean propertiesKey){
        super(message);
     ...
     * @param message  信息描述
     */
    public ParamCheckException(String errorCode, String message, Throwable cause, boolean propertiesKey){
        super(message, cause);
        this.setErrorCode(errorCode);
        this.setPropertiesKey(propertiesKey);
    }
